...
_POSSIBLE_DIRS = [
    os.path.abspath(os.path.join(_BASE_DIR, "..", "data")),
    os.path.abspath(os.path.join(_BASE_DIR, "..", "..", "data")),
    os.path.abspath(os.path.join(_BASE_DIR, "data")),
]
DATA_DIR = next((d for d in _POSSIBLE_DIRS if os.path.exists(d)), _POSSIBLE_DIRS[0])
CACHE_TR = os.path.join(DATA_DIR, "fdtd_cache_highres_training_1629s.npz")
CACHE_VL = os.path.join(DATA_DIR, "fdtd_cache_highres_validation_139s.npz")
