...
PHYSICS = {
    ...
    # *** MATERIAL CORRECTION ***
    # The dataset uses AIR-FILLED vias (bare etched, Bosch DRIE process, no Cu fill).
    # The via interior is AIR (n=1.0). The Fresnel boundary at the via bottom is:
    #   AIR (n=1.0) / Si (n~5.5 at 350nm) interface
    # The Cu constants below are NOT applicable to this dataset and are kept
    # only for reference (they would apply to post-Cu-fill inspection).
    # "n_cu_real": 1.22,         # [DEPRECATED] Cu refractive index at 350nm
    # "n_cu_imag": 1.88,         # [DEPRECATED] Cu extinction coefficient at 350nm

    # Boundary material: Silicon substrate at via bottom (Air/Si interface)
    "n_si_real": 5.5,           # Si refractive index at 350nm (Palik 1998)
    "n_air": 1.0,              # Air refractive index (via interior)
